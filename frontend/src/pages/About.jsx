 ...
 * Hardened for visual impact and historical storytelling.
 * Features background grid ignition and industrial glassmorphism.
 */
    ...
    <div className="min-h-screen bg-[#020617] text-white overflow-x-hidden relative selection:bg-blue-500/30">
      ...
      <div className="relative z-10 px-6 pt-32 pb-24 max-w-7xl mx-auto">
        ...
        >
          {/* Mission Node */}
          <motion.div
            whileHover={{ y: -10, scale: 1.02, borderColor: 'rgba(37,99,235,0.4)' }}
          ...
          {/* Vision Node */}
          <motion.div
            whileHover={{ y: -10, scale: 1.02, borderColor: 'rgba(255,215,0,0.4)' }}
            className="bg-slate-900/40 border border-slate-800 backdrop-blur-3xl p-10 rounded-[2.5rem] shadow-2xl relative overflow-hidden group transition-all duration-500"
          >
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { title: "Skill Forge", text: "Intensive workshops into AI, Dev, and Cyber Security.", icon: "M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" },
              { title: "Network Hub", text: "Building an elite grid of tech-heads and mentors.", icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857" },
              { title: "Innovation Lab", text: "Converting conceptual code into scalable solutions.", icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" }
            ].map((item, index) => (
              <motion.div
                key={index}
        ...
        <motion.div
          className="relative z-10 bg-slate-950/60 border border-slate-800 backdrop-blur-3xl p-16 rounded-[3rem] shadow-3xl text-center overflow-hidden"
