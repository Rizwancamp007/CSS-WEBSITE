 ...
 * Features background grid synchronization and industrial glassmorphism.
 */
export default function Contact() {
   ...
   * Broadcasts the inquiry payload to the secure administrative inbox.
   */
  const handleSubmit = async (e) => {
    ...
    try {
       ...
       * Hits the hardened /messages/public endpoint.
       */
      ...
      if (response.ok) {
        ...
        toast.error(errorData.message || "Protocol rejection.", { id: loadToast });
      }
    } catch (error) {
      toast.error("COMMUNICATION_ERROR: Bridge Connection Lost.", { id: loadToast });
    } finally {
      ...
      <div className="relative z-10 px-6 pt-32 pb-24 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-stretch">
          ...
          <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} className="flex flex-col h-full">
            <motion.div 
              className="bg-slate-900/40 backdrop-blur-3xl p-10 rounded-[2.5rem] border border-slate-800 shadow-3xl h-full relative overflow-hidden transition-all duration-500 hover:border-blue-500/30"
            >
              ...
              <div className="space-y-12">
                <div className="flex items-start gap-6 group">
                  ...
                  <div>
                    ...
                    <p className="text-base text-slate-400 font-medium font-mono">CS Dept, GCU Lahore</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-6 group">
                  ...
                  <div>
                    ...
                    <p className="text-base text-slate-400 font-medium font-mono">css@gcu.edu.pk</p>
                  </div>
                </div>
              </div>
