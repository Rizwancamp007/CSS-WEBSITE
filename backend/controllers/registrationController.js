 ...
 * Hardened for production proxy environments.
 */
const logAction = async (adminId, action, details, req) => {
    try {
        ...
        // LIVE FIX: Improved IP detection for proxied cloud hosting (Render)
...
exports.deleteRegistration = async (req, res) => {
    try {
        ...
        // Atomic correction: reduce counter on the event
